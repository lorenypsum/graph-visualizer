...
A função principal implementa o algoritmo de Chu–Liu/Edmonds de forma recursiva. Ela coordena as etapas do algoritmo, incluindo normalização de custos, construção de \(F^*\), detecção de ciclos, contração, recursão e expansão. A função retorna a r‑arborescência ótima como um dígrafo.
