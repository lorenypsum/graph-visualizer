...
\paragraph{}
O ensino de matemática no ensino superior exige transitar entre registros de representação (intuitivo, visual, simbólico, formal) com intencionalidade didática \cite{tall1991advanced}. A complexidade conceitual eleva a \emph{carga cognitiva intrínseca}, e exposições que não integram bem palavras e figuras adicionam \emph{carga extrínseca} desnecessária \cite{sweller1988cognitive}. Diretrizes de aprendizagem multimídia e de codificação dupla apoiam a integração semântica entre linguagem e diagramas, reduzindo sobrecarga e favorecendo a formação de esquemas \cite{mayer2009multimedia,paivio1990}.

\paragraph{}
Princípios práticos que adotamos ao longo do texto e da ferramenta:
\begin{itemize}\setlength{\itemsep}{2pt}
    \item Andaimagem (scaffolding): começar em instâncias pequenas, explicitar invariantes e generalizar de forma gradual.
    \item Exemplos contrastantes/contraexemplos: demarcam fronteiras conceituais (p.ex., família laminar vs. não‑laminar) e evitam falsas generalizações.
    \item Atividades gerativas: pedir previsões/explicações e “por quês” consolida modelos mentais \cite{mayer2009multimedia}.
\end{itemize}
