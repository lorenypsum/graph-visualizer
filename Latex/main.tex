...
\paragraph{}
Implementamos duas versões do algoritmo de Frank: (i) uma versão didática, voltada à clareza do procedimento; e (ii) uma versão otimizada, que emprega heaps como estrutura auxiliar. Manter ambas permitiu validar o método por meio da comparação sistemática dos resultados.

\paragraph{}
Utilizamos a biblioteca NetworkX para a manipulação de grafos e funções auxiliares para modularizar o código, o que facilita a leitura e a manutenção. A seguir, apresentamos os detalhes de implementação de ambas as versões.
...
\subsection{Como essa solução é diferente da Chu–Liu/Edmonds?}
