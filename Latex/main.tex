...
\paragraph{}
A figura a seguir ilustra a estrutura funcional dessa página.
...
\end{figure}
\textit{Comentário:} Integração de PDF via \texttt{iframe} mantém usuário no contexto da aplicação, reduzindo carga cognitiva de alternância entre janelas.
