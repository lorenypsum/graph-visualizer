...
\paragraph{}
Nesta seção apresentaremos as principais abordagens para encontrar r-arborescências de custo mínimo em dígrafos ponderados. Antes de entrar nos detalhes, faremos uma breve revisão dos conceitos e técnicas que utilizaremos adiante, para uniformizar a notação e tornar a leitura mais fluida.
