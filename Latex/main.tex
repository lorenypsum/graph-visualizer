...
\paragraph{Main.py - Lógica de manipulação de grafos:} o arquivo \texttt{main.py} contém funções para manipulação de grafos, execução dos algoritmos e geração de visualizações. 
