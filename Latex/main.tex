...
\begin{figure}[H]\centering
    \begin{tikzpicture}[>=Stealth, node distance=1.4cm]
        ...
        \node[circle,draw,minimum size=8mm,fill=gray!10,label={[label distance=4mm]above:$x_C$}] (xC) at (3.6,0.4) {$x_C$};
        \node[circle,draw,minimum size=6mm,label={[label distance=4mm]right:$u$}] (u2) at (6.8,0.4) {$u$};
