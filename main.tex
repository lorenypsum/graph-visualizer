...
\paragraph{}
Esse teorema explica por que, em muitas rotinas (inclusive na construção de soluções por contração/condensação), olhar para componentes-fonte e componentes-sumidouro pode levar a estratégicas eficientes de contração ou expansão de subgrafos, especialmente quando o objetivo é garantir ou explorar a forte conexidade.
