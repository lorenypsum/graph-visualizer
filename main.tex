...
\paragraph{}
No lado “dual”, em vez de montar a árvore, colocamos “preços” em cortes do grafo com raiz $r$. A regra é simples: nenhum preço pode ultrapassar o custo das arestas que cruzam o corte. Buscamos escolher esses preços para somar o máximo possível. As arestas que “batem no limite” viram 0‑arestas, e a partir delas conseguimos reconstruir uma arborescência ótima. Essa visão, desenvolvida por Frank, leva a um teorema min–max e a um procedimento em duas etapas: primeiro ajustamos os preços, depois extraímos a solução usando apenas 0‑arestas. 
