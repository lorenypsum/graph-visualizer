...
\newtcolorbox{algobox}[1]{enhanced,breakable,sharp corners,boxsep=6pt,arc=1pt,
    colback=green!3,colframe=black!85,title={Algoritmo: #1}}
...
\begin{algobox}{Algoritmo: Busca Linear}
...
\begin{algobox}{Algoritmo: Busca Binária}
...
\section{Em busca da Arborescência Perdida: Parte 1}
...
\paragraph{}Com esses conceitos e técnicas em mente, estamos prontos para explorar os algoritmos específicos que nos levarão à descoberta da arborescência perdida. No próximo capítulo, detalharemos o algoritmo de Chu–Liu/Edmonds e o procedimento em duas fases de András Frank, explicando suas etapas, intuições e implementações.
