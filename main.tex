...
\begin{tikzpicture}[>=Stealth]
    ...
    % custo total
    \node[align=left, anchor=west] at (3.0,1.8) {Custo total da r-arborescência: $2 + 3 + 1 + 4 + 2 + 5 = 17$};
\end{tikzpicture}
...
\begin{tikzpicture}[>=Stealth]
    ...
    % custo total
    \node[align=left, anchor=west] at (3.0,1.8) {Custo total da r-arborescência inversa: $2 + 3 + 1 + 4 + 2 + 5 = 17$};
\end{tikzpicture}
...
\paragraph{Mais sobre arborescências}
