...
% Algoritmos: paleta roxa
\newtcolorbox{algobox}[1]{enhanced,breakable,sharp corners,boxsep=6pt,arc=1pt,
    colback=green!3,colframe=black!80,fonttitle=\bfseries,coltitle=white,title={Algoritmo: #1}}
% Teoremas: paleta azul | Lemas: paleta verde
\newtcbtheorem[number within=section]{teobox}{Teorema}%
{enhanced,breakable,sharp corners,boxsep=6pt,arc=1pt,
 colback=blue!3,colframe=blue!30,fonttitle=\bfseries,coltitle=black,boxrule=0.6pt}{th}
\newtcbtheorem[number within=section]{lemabox}{Lema}%
{enhanced,breakable,sharp corners,boxsep=6pt,arc=1pt,
 colback=orange!3,colframe=orange!45!black,fonttitle=\bfseries,coltitle=black,boxrule=0.6pt}{lem}
