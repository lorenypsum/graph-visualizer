...
% \begin{center}
% \begingroup
% \setlength{\fboxsep}{14pt}% padding externo
% \fcolorbox{orange!40!black}{orange!5}{%
% \parbox{0.96\textwidth}{%
% 	extbf{Teorema (Fulkerson – condição de cortes para arborescências).} Seja $D=(V,A)$ e $r\in V$. Existe uma out-arborescência (arborescência dirigida) enraizada em $r$ se, e somente se,
% \[
...
\subsection{Algoritmo Chu e Liu}
