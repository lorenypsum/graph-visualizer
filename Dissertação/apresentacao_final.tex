...
\begin{frame}{Fase I: Algoritmo de Fulkerson}
  \begin{columns}[c]
    ...
    \vspace{0.1cm}
    {\small Condensação $\mathcal{C}(D_0)$ com $r$ isolado e duas fontes $S_1, S_2$, ressaltando que $S_1, S_2$ são componentes fortemente conexas. - não vértices individuais.}
  \end{columns}
\end{frame}
...
\begin{frame}{Fase I: Encontrando $r$-conjuntos Minimais}
  ...
  \vspace{0.2cm}
  Seja $D_0 := (V, F)$ onde $F = \{f_i : i \in [k)\}$ (o conjunto de arcos escolhidos).
...
\begin{frame}{Fase I: Iteração 1 - Encontrar $r$-conjunto Minimal}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[selected] (g) to node[midway, above, sloped] {\scriptsize 4} (b);
...
\begin{frame}{Fase I: Iteração 2 - Redução de Pesos}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[arc] (r) to[bend left=13] node[midway, above, sloped] {\scriptsize 5} (a);
      \draw[arc] (r) to node[midway, above, sloped] {\scriptsize \textcolor{green} 1} (b);
      \draw[arc] (r) to[bend right=13] node[midway, below, sloped] {\scriptsize 5} (c);


      \draw[arc] (a) to node[midway, above, sloped] {\scriptsize \textcolor{green} 3} (b);
      ...
      \draw[zero] (g) to node[midway, above, sloped] {\scriptsize \textcolor{green} 0} (b);

      \draw[arc] (f) to node[midway, below, sloped] {\scriptsize 1} (d);

    \end{tikzpicture}
    \vspace{0.05cm}
    {\small Arco em azul tem peso zero}
  \end{columns}
...
\begin{frame}{Fase I: Iteração 3 - Redução de Pesos}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[arc] (r) to[bend right=13] node[midway, below, sloped] {\scriptsize \textcolor{green} 3} (c);


      \draw[arc] (a) to node[midway, above, sloped] {\scriptsize 3} (b);


      \draw[selected] (b) to node[midway, above, sloped] {\scriptsize \textcolor{green} 0} (c);
      \draw[arc] (b) to node[midway, above, sloped] {\scriptsize 5} (d);
...
\begin{frame}{Fase I: Iteração 4 - Redução de Pesos}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[arc] (r) to[bend left=13] node[midway, above, sloped] {\scriptsize \textcolor{green} 2} (a);
      \draw[arc] (r) to node[midway, above, sloped] {\scriptsize 1} (b);
      ...
      \draw[selected] (e) to node[midway, above, sloped] {\scriptsize \textcolor{green} 0} (a);
      \draw[arc] (e) to[bend left=14] node[midway, above, sloped] {\scriptsize 6} (f);
      \draw[arc] (e) to[bend left=14] node[midway, below, sloped] {\scriptsize 4} (d);
...
\begin{frame}{Fase I: Iteração 5 - Redução de Pesos}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[arc] (c) to node[midway, above, sloped] {\scriptsize \textcolor{green} 4} (g);
      \draw[arc] (c) to[bend right=70] node[midway, below, sloped] {\scriptsize 3} (f);

      \draw[arc] (d) to[bend left=14] node[midway, above, sloped] {\scriptsize 4} (e);
      \draw[selected] (d) to node[midway, below, sloped] {\scriptsize \textcolor{green} 0} (g);
...
\begin{frame}{Fase I: Iteração 6 - Redução de Pesos}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[zero] (b) to node[midway, above, sloped] {\scriptsize 0} (c);
      \draw[arc] (b) to node[midway, above, sloped] {\scriptsize \textcolor{green} 4} (d);
      ...
      \draw[zero] (e) to node[midway, above, sloped] {\scriptsize 0} (a);
      \draw[arc] (e) to[bend left=14] node[midway, above, sloped] {\scriptsize 6} (f);
      \draw[arc] (e) to[bend left=14] node[midway, below, sloped] {\scriptsize \textcolor{green} 3} (d);

      \draw[zero] (g) to node[midway, above, sloped] {\scriptsize 0} (b);

      \draw[selected] (f) to node[midway, below, sloped] {\scriptsize \textcolor{green} 0} (d);
...
\begin{frame}{Fase I: Iteração 7 - Redução de Pesos}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[arc] (c) to node[midway, above, sloped] {\scriptsize 4} (g);
      \draw[selected] (c) to[bend right=70] node[midway, below, sloped] {\scriptsize \textcolor{green} 0} (f);

      \draw[arc] (d) to[bend left=14] node[midway, above, sloped] {\scriptsize 4} (e);
      \draw[zero] (d) to node[midway, below, sloped] {\scriptsize 0} (g);

      \draw[zero] (e) to node[midway, above, sloped] {\scriptsize 0} (a);
      \draw[arc] (e) to[bend left=14] node[midway, above, sloped] {\scriptsize \textcolor{green} 3} (f);
...
\begin{frame}{Fase I: Iteração 9 - Estado Final}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[arc] (r) to[bend left=13] node[midway, above, sloped] {\scriptsize \textcolor{green} 1} (a);
      \draw[selected] (r) to node[midway, above, sloped] {\scriptsize \textcolor{green} 0} (b);
      \draw[arc] (r) to[bend right=13] node[midway, below, sloped] {\scriptsize \textcolor{green} 2} (c);
      ...
      \draw[zero] (d) to[bend left=14] node[midway, above, sloped] {\scriptsize 4} (e);
      \draw[zero] (d) to node[midway, below, sloped] {\scriptsize 0} (g);
...
\begin{frame}{Fase II: Exemplo - Extração da Arborescência}
  \begin{columns}[c]
    ...
    \begin{itemize}
      \item $F = [f_0, f_1, f_2, f_3, f_4, f_5, f_6, f_7]$ $= [(b,g), (b,c), (e,a), (d,g), (f,d), (c,f), (d,e), (r,b)]$
    \end{itemize}
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[zero] (r) to node[midway, above, sloped] {\scriptsize 0} (b);
...
\begin{frame}{Fase II: Iteração 1}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[arc] (r) to[bend left=13] node[midway, above, sloped] {\scriptsize 5} (a);
      \draw[zero] (r) to node[midway, above, sloped] {\scriptsize 6} (b);
      \draw[arc] (r) to[bend right=13] node[midway, below, sloped] {\scriptsize 5} (c);
...
\begin{frame}{Fase II: Iteração 2}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[zero] (b) to node[midway, above, sloped] {\scriptsize 2} (c);
      \draw[arc] (b) to node[midway, above, sloped] {\scriptsize 5} (d);
...
\begin{frame}{Fase II: Iteração 3}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[arc] (c) to node[midway, above, sloped] {\scriptsize 8} (g);
      \draw[zero] (c) to[bend right=70] node[midway, below, sloped] {\scriptsize 3} (f);
...
\begin{frame}{Fase II: Iteração 4}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[zero] (f) to node[midway, below, sloped] {\scriptsize 1} (d);
...
\begin{frame}{Fase II: Iteração 5}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[arc] (d) to[bend left=14] node[midway, above, sloped] {\scriptsize 4} (e);
      \draw[zero] (d) to node[midway, below, sloped] {\scriptsize 4} (g);
...
\begin{frame}{Fase II: Iteração 7 (Interação final)}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[zero] (e) to node[midway, above, sloped] {\scriptsize 3} (a);
      \draw[arc] (e) to[bend left=14] node[midway, above, sloped] {\scriptsize 6} (f);
      \draw[arc] (e) to[bend left=14] node[midway, below, sloped] {\scriptsize 4} (d);
