...
\newcommand{\referencediagram}{
  \begin{tikzpicture}[remember picture, overlay]
    \node[anchor=south east, xshift=-0.cm, yshift=0.2cm] at (current page.south east) {
      \begin{tikzpicture}[scale=0.65, >=Stealth,
        ...
        % Frame
        \draw[primarypurple, very thick, rounded corners] 
          ([xshift=-3pt, yshift=2pt] current bounding box.north west) rectangle 
          ([xshift=3pt, yshift=-3pt] current bounding box.south east);
        \node[above, font=\scriptsize\bfseries, color=primarypurple] at (current bounding box.north) {Digrafo Original};
      \end{tikzpicture}
    };
  \end{tikzpicture}
}
