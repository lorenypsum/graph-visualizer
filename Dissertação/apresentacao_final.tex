...
\begin{frame}{Exemplo: Digrafo Inicial}
  \begin{columns}[c]
    ...
    \begin{itemize}
      \item $(r,a): 4$, $(r,b): 6$, $(r,c): 5$
      \item $(a,b): 8$, $(b,c): 2$, $(b,d): 5$
      \item $(c,g): 4$, $(c,f): 3$, $(d,g): 4$
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[arc] (r) to[bend left=13] node[midway, above, sloped] {\scriptsize 4} (a);
      ...
      \draw[arc] (d) to node[midway, below, sloped] {\scriptsize 8} (g);

      \draw[arc] (e) to node[midway, above, sloped] {\scriptsize 3} (a);
      \draw[arc] (e) to[bend left=14] node[midway, above, sloped] {\scriptsize 2} (f);
...
\begin{frame}{Fase I: Iteração 4 - Redução de Pesos}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[arc] (r) to[bend left=13] node[midway, above, sloped] {\scriptsize \textcolor{green} 4} (a);
      \draw[arc] (r) to node[midway, above, sloped] {\scriptsize 1} (b);
      ...
      \draw[selected] (e) to node[midway, above, sloped] {\scriptsize \textcolor{green} 3} (a);
      \draw[arc] (e) to[bend left=14] node[midway, above, sloped] {\scriptsize 2} (f);
      \draw[arc] (e) to[bend left=14] node[midway, below, sloped] {\scriptsize 4} (d);
...
\begin{frame}{Fase I: Iteração 5 - Redução de Pesos}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[arc] (c) to node[midway, above, sloped] {\scriptsize \textcolor{green} 0} (g);
      \draw[arc] (c) to[bend right=70] node[midway, below, sloped] {\scriptsize 3} (f);

      \draw[arc] (d) to[bend left=14] node[midway, above, sloped] {\scriptsize 4} (e);
      \draw[selected] (d) to node[midway, below, sloped] {\scriptsize \textcolor{green} 4} (g);
...
\begin{frame}{Fase I: Iteração 6 - Redução de Pesos}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm, scale=0.9, transform shape,
      ...
      \draw[zero] (b) to node[midway, above, sloped] {\scriptsize 0} (c);
      \draw[arc] (b) to node[midway, above, sloped] {\scriptsize \textcolor{green} 5} (d);

      \draw[arc] (c) to node[midway, above, sloped] {\scriptsize 0} (g);
      \draw[arc] (c) to[bend right=70] node[midway, below, sloped] {\scriptsize 3} (f);
      ...
      \draw[zero] (e) to node[midway, above, sloped] {\scriptsize 3} (a);
      \draw[arc] (e) to[bend left=14] node[midway, above, sloped] {\scriptsize 2} (f);
      \draw[arc] (e) to[bend left=14] node[midway, below, sloped] {\scriptsize \textcolor{green} 4} (d);

      \draw[zero] (g) to node[midway, above, sloped] {\scriptsize 0} (b);

      \draw[selected] (f) to node[midway, below, sloped] {\scriptsize \textcolor{green} 1} (d);
