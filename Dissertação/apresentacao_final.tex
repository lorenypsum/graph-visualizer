...
\begin{frame}{Passo 1: Redução de Pesos}
  \begin{columns}[c]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=2.0cm,
      ...
      \draw[arc] (a) to[bend left=12] node[midway, above, sloped] {\scriptsize 0} (b);
      \draw[arc] (b) to[bend left=12] node[midway, above, sloped] {\scriptsize 0} (c);
      \draw[arc] (c) to[bend left=14] node[midway, below, sloped] {\scriptsize 0} (a);
