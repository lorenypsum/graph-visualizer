...
% Por fim, há o desafio de mapear o “fazer do algoritmo” para a linguagem primal–dual. Ações como elevar potenciais, escolher entradas e contrair ciclos correspondem a garantias teóricas específicas. Em particular, apertude (custo reduzido zero) e complementaridade (exatamente uma aresta entra em cada conjunto ativo) certificam a otimalidade. Relacionar essas ideias às métricas que coletamos — tempos, número de contrações, pico de memória — ajuda a conectar prática e teoria por meio dos custos reduzidos e da reexpansão (Figs.~\ref{fig:didatica-reduced-cost} e \ref{fig:didatica-reexpansion}). A dificuldade típica aparece quando os estudantes executam os passos sem ver como eles tornam certas restrições “justas”; tornar explícitos os vínculos entre ação e certificação reduz a distância entre o operacional e o conceitual.
