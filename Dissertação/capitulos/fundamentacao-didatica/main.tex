...
O segundo desafio envolve acompanhar os efeitos de contração e expansão. Contrair um ciclo, substituindo-o por um supervértice, e depois reexpandir altera os custos reduzidos c e os cortes que permanecem “ativos”. A dificuldade típica emerge quando o estudante perde o fio entre as representações (grafo original, grafo condensado e reexpansão), o que aumenta a carga extrínseca; explicitar as diferenças em cada etapa ajuda a reduzir esse atrito.
