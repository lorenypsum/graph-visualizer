...
\begin{itemize}\setlength{\itemsep}{2pt}
	...
	\item \textbf{Bibliotecas centrais:} NetworkX para manipulação de grafos dirigidos; \texttt{matplotlib} para renderização de snapshots; (em páginas avançadas) Cytoscape.js previsto para interação rica (estrutura já importada em \texttt{chuliu.html}, \texttt{andrasfrank\_v1.html} e \texttt{andrasfrank\_v2.html}).
...
A aplicação centraliza-se nas páginas \texttt{chuliu.html}, \texttt{andrasfrank\_v1.html} e {andrasfrank\_v2.html}, que permitem executar os algoritmos de Chu--Liu/Edmonds e Frank (1° e 2° implementação), respectivamente. A seguir, detalhamos os componentes funcionais principais da interface:
