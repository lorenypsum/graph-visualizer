...
\begin{figure}[H]
    ...
    \caption{Comparação de desempenho entre implementações da Fase~II. \textbf{Esquerda}: boxplots coloridos mostram diferença clara --- v1 (vermelho, lista) tem mediana de \(0{,}98\) s enquanto v2 (azul, heap) reduz para \(0{,}016\) s. \textbf{Direita}: histograma do fator de aceleração mostra distribuição concentrada entre 40× e 80×, com mediana \(58{,}12\times\) (linha tracejada vermelha) e média \(61{,}30\times\) (linha pontilhada laranja).}
    \label{fig:speedup}
\end{figure}
