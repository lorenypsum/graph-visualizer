...
\begin{figure}[H]
    ...
    \caption{Distribuição do número de contrações de ciclos realizadas por Chu--Liu/Edmonds: mediana 2, média \(7{,}89\), máximo 824. A maioria das instâncias requer poucas contrações.}
