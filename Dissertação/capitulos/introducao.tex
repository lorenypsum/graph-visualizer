...
Uma abordagem alternativa foi desenvolvida por András Frank nos anos 1970, decompondo o problema em duas fases distintas: construção de uma cobertura de \textit{r-conjuntos} via redução de pesos (baseada em resultados de Fulkerson \cite{fulkerson}), seguida da extração da arborescência ótima \cite{frankco,frankks}. 
