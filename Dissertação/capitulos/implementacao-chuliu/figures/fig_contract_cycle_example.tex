\begin{tikzpicture}[
    ...
    \begin{scope}[local bounding box=left]
        ...
        \draw[arrow, red, thick] (v3) -- node[midway, right, fill=none, inner sep=1pt, font=\tiny, draw=none, fill=none] {2} (v4);
        ...
        % Outras arestas
        \draw[arrow] (r) -- node[midway, left, fill=none, inner sep=1pt, font=\tiny] {6} (v1);
    ...
    \begin{scope}[local bounding box=right, xshift=11cm]
        ...
        \draw[arrow, blue, thick] (r2) -- node[midway, above left, fill=none, inner sep=1pt, font=\tiny, draw=none, circle] {2} (xc);
