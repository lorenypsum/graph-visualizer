\begin{tikzpicture}[>=Stealth, scale=1.2, every node/.style={scale=1}]
    ...
    \begin{scope}[xshift=0cm]
        ...
        \draw[->,very thick,blue!70] (r) to[bend right=15] node[midway,above left,black,font=\footnotesize] {0} (v1);
        \draw[->,very thick,red,line width=1.2pt] (r) to[bend right=20] node[midway,right,black,font=\footnotesize] {0} (v2);
        ...
        \draw[->,very thick,red,line width=1.2pt] (v4) to[bend right=20] node[midway,above,black,font=\footnotesize] {0} (v2);
        \draw[->,very thick,blue!70] (r) to[bend left=15] node[midway, above,black,font=\footnotesize] {0} (v5);

        % Destaque do ciclo detectado
        % \draw[dashed,red,thick,rounded corners=10pt] (-0.5,-0.3) rectangle (3.5,1.1);
        \draw[dashed,red,thick,rounded corners=10pt] (-0.7,-0.5) rectangle (3.7,1.25);
        \node[above,red,font=\small] at (1.5,1.2) {ciclo detectado};
    ...
    \begin{scope}[xshift=7cm]
        ...
        \draw[->,very thick,red,line width=1.2pt] (cv4) to[bend right=20] node[midway,above,black,font=\footnotesize] {0} (cv2);
