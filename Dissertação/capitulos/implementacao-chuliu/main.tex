...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption{digrafo \(D\) com custos originais. O ciclo \(C = (v_1, v_2, v_3, v_1)\) tem arcos com custos 5, 5 e 2. Existem dois arcos da raíz para o ciclo, ambos com custo 5: \((r, v_1)\) e \((r, v_3)\).}
\end{figure}
