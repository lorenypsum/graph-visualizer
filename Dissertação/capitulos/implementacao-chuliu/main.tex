...
Logo, a função apresentada a seguir detecta a presença de um ciclo dirigido em \(A_0\) e devolve um subdigrafo que o contém; se \(A_0\) for acíclico, devolve \texttt{None}.
