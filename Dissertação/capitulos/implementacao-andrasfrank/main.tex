...
% SAMY: REMOVI PARA EVITAR REPETIÇÃO DESNECESSÁRIA
Vamos desenvolver as ideias do algoritmo utilizando o mesmo dígrafo que apresentamos
no capítulo anterior.

\subsection*{Abordagem Gulosa--Dual}

Considere o dígrafo \(D\) mostrado na Figura 26, o mesmo grafo apresentado na Figura 1, usado anteriormente para ilustrar o algoritmo de Chu--Liu--Edmonds. Suponha que \(T\) seja uma \(r\)-arborescência de custo mínimo; os arcos de \(T\) estão destacados em azul na figura.
