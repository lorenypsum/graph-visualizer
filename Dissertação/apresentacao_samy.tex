...
% ==================== SEÇÃO: RESULTADOS EXPERIMENTAIS ====================
...
\begin{frame}{Escalonamento e Consumo de Memória}
    \begin{columns}[c]
        ...
        \begin{itemize}
            \item Mediana: 11,5 MB (Fase I)
            \item Viável para ambientes com recursos limitados
        \end{itemize}
        \column{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/fig_time_vs_edges_scatter.png}
        % \vspace{0.2cm}
        % \includegraphics[width=\textwidth]{figures/fig_peakmem_hist.png}
    \end{columns}
\end{frame}
...
\begin{frame}{Conclusões dos Experimentos}
    ...
    \end{itemize}
    \vspace{0.3cm}
    \textbf{Próximo passo:} transformar resultados em aprendizagem efetiva via aplicação web interativa!
\end{frame}
