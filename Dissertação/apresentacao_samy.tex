...
\begin{frame}{Interface: Página Principal}
    \begin{figure}
        \centering % Garante a centralização horizontal (alternativa a \begin{center})
        \vfill % Empurra a imagem para baixo, preenchendo o espaço superior
        \includegraphics[width=0.55\textwidth]{../assets/homehtml.png}
        \vfill % Empurra a imagem para cima, preenchendo o espaço inferior
		\vspace{0.8cm}
    \end{figure}
\end{frame}
