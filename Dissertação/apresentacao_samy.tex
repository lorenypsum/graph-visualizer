...
% 		\column{0.5\textwidth}
% 		\hspace*{0.5cm}
%         % \begin{alertblock}{Resumo da Aplicação}
% 		% \textbf{Resumo da Aplicação}
...
\begin{frame}{Princípios de IHC Aplicados}
    ...
    \begin{itemize}
        ...
        \item \textbf{Visão geral com detalhe sob demanda:} Visualização global do grafo e acesso a detalhes conforme interesse.
        ...
        \item \textbf{Prevenção e recuperação de erros:} Validação de entradas e possibilidade de reset do estado.
    \end{itemize}
    \vspace{0.2cm}
...
\begin{frame}{Princípios de IHC Aplicados}
    ...
    \begin{alertblock}{Impacto}
        Esses princípios garantem uma experiência didática acessível, eficiente e engajadora, facilitando o aprendizado dos algoritmos de arborescências dirigidas.
    \end{alertblock}
\end{frame}
% ...existing code...
