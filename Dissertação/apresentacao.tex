...
\begin{frame}{Passo 1: Implementação da Redução de Custos em Python}
...
\begin{frame}{Passo 2: Implementação da Construção de D0 em Python}
...
\begin{frame}{Passo 3: Implementação da Verificação de D0 em Python}
\end{frame}
...
\begin{frame}{Passo 4: Implementação da Contração de Ciclos em Python}
\end{frame}
...
\begin{frame}{Passo 5: Implementação da Chamada Recursiva em Python}
\end{frame}
...
\begin{frame}{Passo 6: Implementação da Reexpansão da Solução em Python}
\end{frame}
