...
% ==================== SLIDE 3: EXEMPLO ====================
\begin{frame}{Exemplo: $r$-Arborescência Geradora}
	\textbf{Exemplo de uma r-arborescência mínima:}
	\begin{columns}[c]
		\column{0.4\textwidth}
		\begin{figure}[H]
			\begin{tikzpicture}[scale=0.9,
					vertex/.style={circle,draw,fill=blue!10,minimum size=0.6cm,font=\small},
					edge/.style={->,>=stealth,thick,gray!40}]
				...
				\draw[edge] (r) -- node[above,font=\tiny] {5} (b);
				...
				\draw[edge] (a) to[bend right] node[below,font=\tiny] {6} (e);
		...
		\begin{figure}[H]
			...
			\end{tikzpicture}
			\caption{r-Arborescência Geradora Mínima}
		\end{figure}
		\vspace{0.3cm}
		{\small Custo total: $3 + 4 + 1 + 2 + 2 + 4 = 16$}
	\end{columns}
\end{frame}
