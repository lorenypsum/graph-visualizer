...
\end{lstlisting}
	...
	\vspace{0.2cm}
	{\small Para cada vértice externo, encontra o arco de menor custo para o ciclo}
\end{frame}
...
\end{lstlisting}
	...
	\vspace{0.2cm}
	{\small Os dicionários são usados na expansão. Complexidade: $O(m)$}
\end{frame}
...
\end{lstlisting}
	...
	\vspace{0.2cm}
	{\small Identifica qual arco do ciclo não será incluído na solução}
\end{frame}
